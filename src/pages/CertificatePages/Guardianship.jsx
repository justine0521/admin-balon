...
function Guardianship() {
  ...
  const filteredRequests = requests.filter((request) =>
    request.guardian.toLowerCase().includes(searchTerm.toLowerCase()) 
  );
      ...
      <div className="text-sm">
        <div className="flex justify-between items-center h-14 w-full border-b-2 border-b-gray-400">
          ...
          <div className='flex justify-center items-center gap-x-2 text-sm'>
            ...
            /
            <p className='text-gray-400 cursor-pointer'>Guardianship</p>
          </div>
        </div>
        ...
        <div className="flex justify-between items-center py-3">
          <div className="flex items-center gap-x-2">
            ...
            <select id="entries" value={entriesToShow} onChange={handleEntriesChange} className="border border-gray-300 rounded-md px-2 py-1">
        ...
        {filteredRequests.length === 0 ? (
          <div className="text-center py-5 text-gray-500">No one to issue Guardianship</div>
        ) : (
          <div>
              ...
              <tbody className="text-center divide-y divide-gray-300">
                {currentFilteredRequests.map((request, index) => (
                  <tr key={request._id} className="hover:bg-white">
                    ...
                    <td className="py-4 text-sm">{request.guardian}</td>
