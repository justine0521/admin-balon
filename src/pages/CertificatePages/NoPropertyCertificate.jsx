    ...
    <div className="w-4/5 h-screen mt-14 left-56 p-7 absolute">
      <div className="bg-White">
        <div className="flex justify-between items-center h-16 bg-White px-5 w-full border border-b-gray-300">
          <p className='text-xl'>Certificate of No Property Issuance</p>
            ...
            <NavLink to={'/certificate-of-no-property'}>
              {({isActive}) => (
                <p className={`${isActive ? 'text-gray-300' : 'text-Green'}`} >Certificate of No Property</p>
              )}
            </NavLink>
            </div>
              ...
              <tbody className="text-center bg-white divide-y divide-gray-300">
                {data.slice(startIndex, endIndex).map((resident, index) => (
                  <tr className="hover:bg-gray-100">
                    ...
                    <td>
                      <NavLink to={'/barangay-certificate-of-no-property'}>
...
export default NoPropertyCertificate