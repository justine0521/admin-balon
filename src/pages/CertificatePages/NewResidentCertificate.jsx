...
function NewResidentCertificate() {
  ...
  useEffect(() => {
    const fetchRequests = async () => {
      try {
        // Replace with the correct certId for New Resident Certificates
        const response = await axios.get('http://localhost:5000/api/certificates?certId=9'); // Use certId for New Resident Certificate
    ...
    <div className="w-4/5 h-screen mt-14 left-56 p-7 absolute">
      <div className="bg-White">
        <div className="flex justify-between items-center h-16 bg-White px-5 w-full border border-b-gray-300">
          <p className='text-xl'>Certificate of New Residency Issuance</p>
...
export default NewResidentCertificate;
