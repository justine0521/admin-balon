  ...
  return (
    <section className="bg-gray-100 px-10">
      <div className="flex flex-col items-center justify-center h-screen">
        <button onClick={handleBack} className='absolute top-3 left-5 flex items-center gap-2 italic font-semibold w-fit text-lg transition-all duration-300 hover:gap-0 hover:text-gray-500'>
