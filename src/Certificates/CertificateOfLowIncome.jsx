        ...
        <div className='bg-white h-fit w-full  font-serif'>
            ...
            <div className='flex border-y-4 border-black gap-5 bg-fit bg-no-repeat relative' >
                ...
                <main className='w-[800px] flex flex-col items-center relative'>
                    <h1 className='text-4xl mt-16 w-full text-center font-serif'>CERTIFICATE OF LOW INCOME</h1>
                    ...
                    <div contenteditable="true" className='px-7 mt-20'>
                        ...
                        <p className='mb-5'>It is further certified that the above-named individual belongs to a low-income household, with an annual income not exceeding the threshold established by the government for low-income status.</p>
