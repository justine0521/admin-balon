                ...
                <div className='flex border-y-4 border-black gap-5 bg-fit bg-no-repeat relative' >
                    ...
                    <main className='w-[800px] flex flex-col items-center relative'>
                        ...
                        <div contenteditable="true" className='px-7 mt-20'>
                            ...
                            <p className='mb-5'>&nbsp; &nbsp; &nbsp; &nbsp; This is to certify that <span className='font-bold'>{requestDetails?.fullName || '_________________'}</span>, of Legal age, Married, Filipino has recently established residence at Barangay Balon Anito, Mariveles, Bataan.</p>
