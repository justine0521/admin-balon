                ...
                <div className='h-full border-8 border-transparent relative '>
                    ...
                    <div className='mt-10'>
                        <div className='text-center font-serif flex flex-col gap-y-5'>
                            ...
                            <p className='text-3xl'>CERTIFICATE OF NO PROPERTY</p>
                        </div>
                        ...
                        <div className='font-serif px-7'>
                            ...
                            <div contenteditable="true" className='text-gray-500'>
                                ...
                                <span className="underline">_______</span> years old, <span className="underline">Merried</span>, Filipino, a resident of Barangay Balon Anito, Mariveles, Bataan.</p>
                                <br />
                                <p>This certification is issued upon the request of the above-named person for the purpose of attesting that he/she has no property or landholdings within the jurisdiction of Barangay Balon Anito.</p>
                                <br />
                                <p>To certify further, that according to the records of this barangay, he/she has not been involved in any property disputes or claims.</p>
                                <br />
                                <p><span className="font-semibold text-black">ISSUED </span> this ______ day of _______________________, <span id="currentYear"></span> at Barangay Balon Anito, Mariveles, Bataan, upon the request of the interested party for whatever legal purposes it may serve.</p>
                            </div>
