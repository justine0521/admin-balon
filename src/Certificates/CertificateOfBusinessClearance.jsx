...
function CertficateOfBussinessClearance() {
            ...
            <div className='h-full border-8 border-transparent relative '>
                ...
                <div className='mt-10'>
                    <div className='text-center font-serif flex flex-col gap-y-5'>
                        ...
                        <p className='text-3xl'>BUSINESS CLEARANCE</p>
                    </div>
                    ...
                    <div className='font-serif px-7'>
                        ...
                        <div contenteditable="true" className='text-gray-500'>
                            <p>This is to certify that________________________________________signature and community Tax No. appears below, is engaged in business as operator of __________________________________, in this Barangay.
                            
                            <br />
                            <br />

                            <p>The operator of <span contenteditable="true" className='uppercase'>_______________________</span> has no any liabilities record file in this reference as of this date.</p>

                            <br />
                            
                            <p>This clearance is issued upon request of the named person for his/her reference purpose.</p>
...
export default CertficateOfBussinessClearance