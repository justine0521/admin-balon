                ...
                <div className='flex border-y-4 border-black gap-5 bg-fit bg-no-repeat relative' >
                    ...
                    <main className='w-[800px] flex flex-col items-center relative'>
                        ...
                        <div contenteditable="true" className='px-7 mt-20'>
                            ...
                            <p className='mb-5'>&nbsp; &nbsp; &nbsp; &nbsp; This is to certify that <span className='font-bold'>{requestDetails?.fullName || '_________________'}</span>, of {requestDetails?.age > 18 ? 'Legal age' : '___'}, {requestDetails?.civilStatus}, Filipino and a Bonifide resident of <span>{requestDetails?.address || '_______________'}</span>, Barangay Balon-Anito, Mariveles, Bataan. To Certify further, that {requestDetails?.gender === 'Male' ? 'he' : 'she'} has no derogatory and/or criminal records filed in this barangay.</p>
