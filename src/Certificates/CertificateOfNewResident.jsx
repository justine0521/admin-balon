                ...
                <div className='h-full border-8 border-transparent relative '>
                    ...
                    <div className='mt-10'>
                        <div className='text-center font-serif flex flex-col gap-y-5'>
                            ...
                            <p className='text-3xl'>CERTIFICATE OF NEW RESIDENT</p>
                        </div>
                        ...
                        <div className='font-serif px-7'>
                            ...
                            <div contenteditable="true" className='text-gray-500'>
                                ...
                                <span className="underline">_________</span> (Civil Status), Filipino, has recently established residence at Barangay Balon Anito, Mariveles, Bataan.</p>
                                
                                <br />

                                <p>This certification is issued to acknowledge the new residency of the individual mentioned above for any legal purpose it may serve.</p>
