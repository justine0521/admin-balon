                ...
                <div className='h-full border-8 border-transparent relative '>
                    ...
                    <div className='mt-10'>
                        <div className='text-center font-serif flex flex-col gap-y-5'>
                            ...
                            <p className='text-3xl'>DEATH CERTIFICATE</p>
                        </div>
                        ...
                        <div className='font-serif px-7'>
                            ...
                            <div contenteditable="true" className='text-gray-500'>
                                ...
                                Merried, Filipino, a resident of Barangay Balon Anito, Mariveles, Bataan.
                                
                                <br />
                                <br />
    
                                <p>Further certify that the above-named person passed away on February 06, 2021 at Balon Anito, Mariveles, Bataan due to sickness. </p>
    
                                <br />
                                
                                <p>This certification is issued upon the request of _______________________, wife, for whatever legal purpose it may serve.</p>
