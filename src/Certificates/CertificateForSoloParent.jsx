                ...
                <div className='h-full border-8 border-transparent relative '>
                    ...
                    <div className='mt-10'>
                        <div className='text-center font-serif flex flex-col gap-y-5'>
                            ...
                            <p className='text-3xl'>CERTIFICATE OF SOLO PARENT</p>
                        </div>
                        ...
                        <div className='font-serif px-7'>
                            ...
                            <div contenteditable="true" className='text-gray-500'>
                                ...
                                <span className="underline">_________</span> (Civil Status), Filipino, is a solo parent residing at Barangay Balon Anito, Mariveles, Bataan.</p>
                                
                                <br />

                                <p>This certification is issued upon the request of the interested party for any legal purpose it may serve.</p>
