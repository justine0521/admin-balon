...
function CertificateOfRecidency() {
                ...
                <div className='h-full border-8 border-transparent relative '>
                    ...
                    <div className='mt-10'>
                        <div className='text-center font-serif flex flex-col gap-y-5'>
                            ...
                            <p className='text-3xl'>CERTIFICATE OF RESIDENCY</p>
                        </div>
                        ...
                        <div className='font-serif px-7'>
                            ...
                            <div className='text-gray-500'>
                                ...
                                single, Filipino citizen, is a <span className='text-black'>PERMANENT RESIDENT</span> of this Barangay Balon Anito, Mariveles, Bataan.
                                
                                <br />
                                <br />

                                <p>Based on records of this office, he/she has been residing at Balon Anito, Mariveles, Bataan.</p>
...
export default CertificateOfRecidency