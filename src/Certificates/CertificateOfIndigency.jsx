            ...
            <div className='h-full border-8 border-transparent relative '>
                ...
                <div className='mt-10'>
                    <div className='text-center font-serif flex flex-col gap-y-5'>
                        ...
                        <p className='text-3xl'>CERTIFICATE OF INDIGENCY</p>
                    </div>
                    ...
                    <div className='font-serif px-7'>
                        ...
                        <div className='text-gray-500'>
                            <p>This is to certify that________________________________________, _______years old, male, 
                            single, a bona fide resident of Barangay Balon Anito, Mariveles, Bataan is among in the list of <span className='text-black'>INDIGENT FAMILIES</span> in our Barangay.
                            
                            <br />
                            <br />

                            <p>This certification is hereby issued upon the request of the above mentioned name for whatever purposes it may serve.</p>
