...
function CertificateOfIndigency() {
    ...
    const handleBack = () => {
        localStorage.setItem("activeSection", "CertificateOfIndigency");
        navigate('/CertificateOfIndigency');
    };
            ...
            <div className='bg-white h-fit w-full  font-serif'>
                ...
                <div className='flex border-y-4 border-black gap-5 bg-fit bg-no-repeat relative' >
                    ...
                    <main className='w-[800px] flex flex-col items-center relative'>
                        <h1 className='text-4xl mt-16  font-serif'>CERTIFICATE OF INDIGENCY</h1>

                        <div contenteditable="true" className='px-7 mt-20'>
                            <p className='mb-5'>TO WHOM IT MAY CONCERN:</p>

                            <p className='mb-5'>&nbsp; &nbsp; &nbsp; &nbsp; This is to certify that <span className='font-bold'>{requestDetails?.fullName}</span>, of Legal age, {requestDetails?.civilStatus}, Filipino and a Bonifide resident of <span>{requestDetails?.address}</span>, Barangay Balon-Anito, Mariveles, Bataan belongs to no permanent income and indigent families of this barangay.</p>
