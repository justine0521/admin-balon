...
function IndigencyViewDetails() {
  ...
  useEffect(() => {
    const fetchResidentDetails = async () => {
      try {
        const response = await axios.get(`${API_BASE_URL}/api/indigency?id=${id}`);
      ...
      <div className="bg-white p-5 flex flex-col md:flex-row items-start gap-8 h-[600px]">
        ...
        <div className="flex-1">
          ...
          <div className="grid grid-cols-1 md:grid-cols-1 gap-4">
            ...
            <p className="text-gray-700"><span className="font-semibold">Saan Gagamitin: </span> {resident.purpose}</p>
...
export default IndigencyViewDetails;
