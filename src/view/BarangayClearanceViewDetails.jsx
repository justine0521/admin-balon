...
function BarangayClearanceDetails() {
  ...
  const handleFileUpload = async (e) => {
    ...
    try {
      ...
      const response = await axios.put(`${API_BASE_URL}/api/barangayClearanceUpdatePhoto/${id}`, {
      ...
      <div className='header-container'>
        <header className='bg-white flex justify-between items-center py-3 px-3 border-b-2'>
          ...
          <div className='flex gap-x-5'>
            ...
            <input type="file" id="fileInput" accept="image/*" onChange={handleFileUpload} className="hidden" title="Click to change profile photo"/>
